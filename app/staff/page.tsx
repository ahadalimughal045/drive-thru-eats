                ...
                {allMenuItems.filter(item => 
                  ...
                  >
                    <div className="aspect-[4/3] rounded-3xl bg-brand-bg overflow-hidden mb-4 relative">
                      <img src={item.image && (item.image.startsWith('http') || item.image.startsWith('data:')) ? item.image : `/admin/oimg/${item.image}`} alt={item.name || "Menu item"} className="w-full h-full object-cover group-hover:scale-110 transition-all duration-500" />
